...
app.post('/callback', async (req, res) => {
    ...
    try {
        ...
        console.log('API Response:', response.body.messagePayload);
        console.log('API Response:', req.body.messagePayload.text);
        res.json({ messagePayload: req.body.messagePayload.text });
    } catch (error) {
